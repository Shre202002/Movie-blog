...
import { InstantSearch, SearchBox, Hits, Highlight, useSearchBox, useInstantSearch, Configure } from 'react-instantsearch';
            ...
            <div className="relative w-full">
              <SearchBox
                ...
                classNames={{
                  ...
                  form: 'relative',
                  input:
                    'w-full h-12 pl-10 pr-4 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500',
                  submit: 'hidden',
                }}
              />
              <SearchIcon
